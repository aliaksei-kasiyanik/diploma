...
//         int i = 1;
//         double[] y_k = y0;
//         double[] y_k_1 = normalize(multiply(A, y_k));
//         double[] y_k_2 = normalize(multiply(A, y_k_1));
//         double[] y_k_3 = normalize(multiply(A, y_k_2));
...
//             y_k_1 = y_k_2;
//             y_k_2 = y_k_3;
//             y_k_3 = normalize(multiply(A, y_k_2));
...
//     }
    ...
    private boolean checkRealConvergence(double lambda, double new_lambda) {
        double tmp = Math.abs(lambda - new_lambda);
