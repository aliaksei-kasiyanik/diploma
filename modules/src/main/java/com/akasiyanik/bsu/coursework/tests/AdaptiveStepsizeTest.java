...
import com.akasiyanik.bsu.coursework.solvers.HiresSolverWithClarification;
...
public class AdaptiveStepsizeTest {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("ITERATION_CLARIFICATION: 4");
        for (int i = -11; i >= -11; i--) {
            double tol = Math.pow(10, i);
            System.out.println("TOL: " + tol);
            adaptiveStepsizeTest.test(tol);
        }
